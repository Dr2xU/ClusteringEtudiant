...
def test_teacher_service(session):
    teacher = create_teacher("teacher@test.com", "teachpass", "Bob", "Teacher", "Physics")
...
def test_student_service(session):
    student = create_student("student@test.com", "studypass", "Charlie", "Student", "CS101", "A")
...
def test_create_and_fetch_election(session):
    teacher = create_teacher("teacher2@test.com", "pass", "Dana", "Doe", "Math")
